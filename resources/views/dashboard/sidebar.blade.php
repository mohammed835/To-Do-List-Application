<div id="left-sidebar" class="sidebar">
    ...
    <div class="sidebar-scroll">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#setting"><i class="fa fa-cog"></i></a>
            </li>
        ...
        <div class="tab-content padding-0">
            <div class="tab-pane active" id="menu">
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu li_animation_delay">
                        ...
                        <li>
                            <a href="#" class="has-arrow"><i class="fa fa-puzzle-piece"></i><span>Tasks</span></a>
                            <ul>
                                <li><a href="{{ route('add_task') }}">Add task</a></li>
                                <li><a href="{{ route('otherTask') }}">otherTask</a></li>
                                <li><a href="{{ route('taskBoard') }}">taskBoard</a></li>
                                <li><a href="{{ route('show_task') }}">show task</a></li>

                                {{-- <li><a href="{{ route('responseTasks') }}">Responding to Tasks</a></li> --}}
            ...
            <div class="tab-pane" id="setting">
                ...
                <ul class="mt-3 list-unstyled font_setting">
                    <li>
